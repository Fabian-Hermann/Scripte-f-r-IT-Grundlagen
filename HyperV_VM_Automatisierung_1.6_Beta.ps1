...
# Virtual Drive Size for the UI
 ...
 elseif ($Speicher -ge 10 ){
   ForEach-Object {"{0,-2} {1,-19} {2} {3} {4,-29} #" -f $hash ,$DriveSizeDefaultUI, $divider, $Speicher, $DriveSizeDefaultAppendUI}
}

 elseif ($Speicher -lt 10 ){
   ForEach-Object {"{0,-2} {1,-19} {2} {3} {4,-30} #" -f $hash ,$DriveSizeDefaultUI, $divider, $Speicher, $DriveSizeDefaultAppendUI}
}
